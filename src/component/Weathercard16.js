...
const Weathercard0 = ({
    ...
    return (
        ...
        <div className='weathercard'>
                <div className='datetime'>{day16}
                    <div className='icon'><img src={`http://openweathermap.org/img/wn/${icon16}@2x.png`} alt='image'/>
                        <div className='temp'> {Temper16}&deg;F
                            <div className='weathermood'>{weathermood16}

...
const Weathercard0 = ({
    ...
    return (
        ...
        <div className='weathercard'>
                <div className='datetime'>{day32}
                    <div className='icon'><img src={`http://openweathermap.org/img/wn/${icon32}@2x.png`} alt='image'/>
                        <div className='temp'> {Temper32}&deg;F
                            <div className='weathermood'>{weathermood32}
